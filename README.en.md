...
> A portfolio movie and TV discovery app built with React, TMDB, Supabase, and DeepSeek.
...
- Describe what you want to watch and select movies, TV, or both; DeepSeek analyzes signed-in requests before TMDB builds the lineup
