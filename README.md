...
> 使用 React、TMDB、Supabase 與 AI 模型製作的作品集電影／影集探索與推薦網站。
...
React 19、TypeScript、Vite、Tailwind CSS 4、React Router、TanStack Query、Zustand、Supabase、TMDB、OMDb 與 AI 模型。
...
- AI 供應商金鑰與伺服器端電影資料 token 存放於 Supabase Secrets，前端不會收到。
